...
function wp_player_get_meta_text_input( $args = array(), $value = false ) {
	...
	<tr>
		<td>
			...
			<input type="text" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php esc_html( $value ); ?>" size="30" tabindex="30" style="width: 97%;" />
...
function wp_player_get_meta_textarea( $args = array(), $value = false ) {
	...
	<tr>
		<td>
			<label for="<?php echo $name; ?>" style="font-weight:bold;font-size:14px;"><?php echo $title; ?></label>
			<div style="margin-bottom:5px;font-size:12px;color:#666;display:block;"><?php echo $description; ?></div>
			<textarea name="<?php echo $name; ?>" id="<?php echo $name; ?>" cols="60" rows="4" tabindex="30" style="width: 97%;"><?php esc_html( $value ); ?></textarea>
			<input type="hidden" name="<?php echo $name; ?>_noncename" id="<?php echo $name; ?>_noncename" value="<?php echo wp_create_nonce( plugin_basename( __FILE__ ) ); ?>" />
		</td>
	</tr>
	<?php
...
function wp_player_get_meta_upload( $args = array(), $value = false ) {
	...
	<tr>
		<td>
			<label for="<?php echo $name; ?>" style="font-weight:bold;font-size:14px;"><?php echo $title; ?></label>
			<div style="margin-bottom:5px;font-size:12px;color:#666;display:block;"><?php echo $description; ?></div>
			<input type="text" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php esc_html( $value ); ?>" size="30" tabindex="30" style="width: 85%;" />
